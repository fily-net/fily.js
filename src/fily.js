var $ = (function () {
    ...
    var u = navigator.userAgent.toLowerCase(), isIE = (u.indexOf('msie') > 0), isFF = (u.indexOf('firefox') > 0), bsVer = (u.match(/.+(?:rv|it|ra|ie)[\/: ]([\d.]+)/) || [])[1],//获得版本
        ...
        $W = window,
        $M = Math,
        $DE = $D.documentElement, isPad = ("createTouch" in $D), _fn = function () {
        },
        $ = function (s) {
            if (s === '') {
                return $.getType();
            ...
            if (t == 'function') {
                ...
                return (t == 'string' ? (s.charAt(0) == '{' ? (eval('(' + s + ')')) : $.ext($D.getElementById(s), _x)) : $.ext(s, _x));
            }
            ;
        };
    var _s = {
            ...
            cn2css: function () {
                var a = this.replace(/\s{2,}/g, ' ').split(" "), cssAry = [];
                for (var i = 0; i < a.length; i++) cssAry[i] = $.skin.classObj[a[i]];
                return cssAry.join(';') + ';';
            },
            esHtml: function () {
                ...
                for (var i = 0, _len = _ss.length; i < _len; i++) {
                    if (_ss[i].indexOf('src') != -1) {
                        ...
                        for (var idx = 0; idx < _attrAry.length; idx++) {
                            ...
                            if (_kv[0] == 'src') {
                                _load.loadjs(_kv[1].replaceAll('"', '').trim());
                            }
                            ;
                        }
                    } else {
                        if (_ss[i] && ('<script' + _ss[i]).match(/<script[^>]*>([^\x00]+)<\/script>$/i)) {
                            eval(('<script' + _ss[i]).match(/<script[^>]*>([^\x00]+)<\/script>$/i)[1].trim());
                        }
                    }
                }
                ;
            ...
            format: function () {
                var s = this, a = [];
                for (var i = 0, l = arguments.length; i < l; i++) a.push(arguments[i]);
            ...
            dc: function (s) {
                if (this.ec(s)) {
                    return this.replace(new RegExp('(^' + s + '\\s)|(\\s' + s + '$)|(\\s' + s + '\\s)|(^' + s + '$)', 'g'), '').replace(/\s{2,}/g, ' ');
                } else return this;
            },
            ...
            XHR: function () {
                ...
                function onStateChange() {
                    if (XHR.readyState == 4) {
                        ...
                        if (e >= 400 && e < 500) {
                            _onErr("Clinet Error," + e);
                            return;
                        }
                        if (e >= 500) {
                            _onErr("Server Error," + e);
                            return;
                        }
                        if (e == 200) {
                            _onSucc(t);
                ...
                me.request = function (url, args, cbFn, method, async) {
                    ...
                    var _timeoutFn = setTimeout(function () {
                        XHR.abort();
                        clearInterval(_timeoutFn);
                        _onErr("Timeout");
                        _onTO();
                    }, 2e4);
                    if (_m == 'POST') {
                ...
                if (arguments.length) {
                    me.request(arguments[0], arguments[1], arguments[2], arguments[3]);
                }
                ;
                return me;
            },
        ...
        _a = {
            ...
            re: function (v) {
                while (1) {
                    var n = this.idxOf(v);
                    if (n >= 0) this.reAt(n); else return this;
                }
                ;
            },
            reAt: function (n) {
        ...
        _d = {
            date8: function (s) {
                var m = this.getMonth() + 1, d = this.getDate(), m = m <= 9 ? ("0" + m) : m, d = d <= 9 ? ("0" + d) : d, s = s || '';
            ...
            str2Date: function (str) {
                ...
                this.setFullYear($.m.p(a[0] || 1900), $.m.p(a[1] || 1) - 1, $.m.p(a[2] || 1));
                this.setHours($.m.p(a[3] || 0));
                this.setMinutes($.m.p(a[4] || 0));
                this.setSeconds($.m.p(a[5] || 0));
                return this;
            },
        ...
        _x = {
                ...
                function anitime() {
                    ...
                    for (var i = 0; i < l; i++) {
                        ...
                        if (pAry[i] == 'alpha') {
                            ...
                            $S(me)[pAry[i]] = $M.ceil(sAry[i]) + ifPx;
                        }
                    }
                ...
                switch ($.getType(_u)) {
                    ...
                    case 'string':
                        ...
                        if (_suffix == '.js') {
                            ...
                            $.ajax({
                                url: _u, dataType: 'html', onSuccess: function (rt) {
                                    rt.toString().parseHtml(_m);
                                    _f(rt);
                                }
                            });
                        }
            ...
            adElm: function (a, b) {
                ...
                this.appendChild(e);
                return $(e);
            },//可解决先$C再innerHTML的内存泄露问题
            appendTo: function (o) {
                o.appendChild(this);
                return this;
            },
            scrollTo: function (a) {
                var _args = $.init(a, {onScroll: _fn, onComplete: _fn}), _kv = {
                    'left': 'scrollLeft',
                    'top': 'scrollTop',
                    'width': 'scrollWidth',
                    'height': 'scrollHeight'
                ...
                for (var i in _args) {
                    if ($.getType(_args[i]) == 'function') {
                        continue;
                    }
                    ;
                    _k = _kv[i.toLowerCase()];
                    $.animate({
                        begin: _self[_k],
                        end: _args[i],
                        step: 16,
            ...
            csn: function (s) {
                return $.m.p(this.cs(s));
            },
            css: function (s) {
                var me = this, l = s.split(';');
                l.ec(function (i) {
                    var t = this[i].split(':'), s;
                    if (t[2]) {
                        s = t[1] + ":" + t[2];
                    } else {
                        s = t[1];
            ...
            replaceHtml: function (s) {
                var e = this.cloneNode(false), d = this.parentNode ? this.parentNode : $D;
                e.innerHTML = s;
            ...
            pos: function (p) {
                ...
                if (this.getBoundingClientRect) {
                    ...
                    for (; obj != p; x += obj.offsetLeft, y += obj.offsetTop, obj = obj.offsetParent) {
                    }
                    ;
                }
                ;
            ...
            },//getBoundingClientRect 来替换pos方法
            pn: function (n) {
                if (!n) {
            ...
            print: function () {
                ...
                for (var i = 0, _len = _sAry.length; i < _len; i++) {
                    html += "<style type='text/css'>" + _sAry[i].innerHTML + "</style>";
                }
                ;
                for (var i = 0, _len = _lAry.length; i < _len; i++) {
                    html += _lAry[i].outerHTML;
                }
                ;
                html += "<style media=print>.Noprint{display:none;}.PageNext{page-break-after: always;}</style></head><body><div class='wp hp'>";
                for (var i = 0, _len = _chs.length; i < _len; i++) {
                    var _node = _chs[i];
                    if (_node.nodeType == 3) {
        ...
        _tween = {
            ...
            easeOutInCubic: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeOutCubic(t * 2, b, c / 2, d);
                }
                ;
                return _tween.easeInCubic((t * 2) - d, b + c / 2, c / 2, d);
            },
            ...
            easeOutInQuart: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeOutQuart(t * 2, b, c / 2, d);
                }
                ;
                return _tween.easeInQuart((t * 2) - d, b + c / 2, c / 2, d);
            },
            ...
            easeOutInQuint: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeOutQuint(t * 2, b, c / 2, d);
                }
                ;
                return _tween.easeInQuint((t * 2) - d, b + c / 2, c / 2, d);
            },
            ...
            easeOutInSine: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeOutSine(t * 2, b, c / 2, d);
                }
                ;
                return _tween.easeInSine((t * 2) - d, b + c / 2, c / 2, d);
            },
            ...
            easeOutInExpo: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeOutExpo(t * 2, b, c / 2, d);
                }
                ;
                return _tween.easeInExpo((t * 2) - d, b + c / 2, c / 2, d);
            },
            ...
            easeOutInCirc: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeOutCirc(t * 2, b, c / 2, d);
                }
                ;
                return _tween.easeInCirc((t * 2) - d, b + c / 2, c / 2, d);
            },
            ...
            easeOutInElastic: function (t, b, c, d, a, p) {
                if (t < d / 2) {
                    return _tween.easeOutElastic(t * 2, b, c / 2, d, a, p);
                }
                ;
                return _tween.easeInElastic((t * 2) - d, b + c / 2, c / 2, d, a, p);
            },
            ...
            easeOutInBack: function (t, b, c, d, s) {
                if (t < d / 2) {
                    return _tween.easeOutBack(t * 2, b, c / 2, d, s);
                }
                ;
                return _tween.easeInBack((t * 2) - d, b + c / 2, c / 2, d, s);
            },
            easeInBounce: function (t, b, c, d) {
                return c - _tween.easeOutBounce(d - t, 0, c, d) + b;
            },
            ...
            easeInOutBounce: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeInBounce(t * 2, 0, c, d) * .5 + b;
                } else {
                    return _tween.easeOutBounce(t * 2 - d, 0, c, d) * .5 + c * .5 + b;
                }
                ;
            },
            easeOutInBounce: function (t, b, c, d) {
                if (t < d / 2) {
                    return _tween.easeOutBounce(t * 2, b, c / 2, d);
                }
                ;
                return _tween.easeInBounce((t * 2) - d, b + c / 2, c / 2, d);
            }
        },//---end---tween
        _load = {
            loadjs: function (url, callback, part) {
                ...
                for (var i = 0, _sLen = _stAry.length; i < _sLen; i++) {
                    if (_stAry[i].src == url) {
                        _cbfn(_stAry[i]);
                        return;
                    }
            ...
            loadcss: function (url, callback, part) {
                ...
                for (var i = 0, _sLen = _stAry.length; i < _sLen; i++) {
                    if (_stAry[i].href == url) {
                        _cbfn(_stAry[i]);
                        return;
                    }
                }
                var eDom = document.getElementsByTagName(part || 'body').item(0), link = document.createElement('link');
                link.onload = link.onreadystatechange = link.onerror = function () {
                    if (link && link.readyState && /^(?!(?:loaded|complete)$)/.test(link.readyState)) {
                        return;
                    }
                    ;
        ...
        _o = {
            ...
            extend: function (fn, a) {
                return fn.apply ? (fn.apply(this, a), this) : this;
            },
            extendView: function (a, b) {
                return $.view.call(this, a, b), this;
            }
        },
        _w = {
            timeIntervalArray: [],
            ...
            $C: function (id, tag) {
                if (tag) {
                    ...
                    if (id != '' && id != null) e.setAttribute('id', id);
                    return $(e);
                } else {
                    return $D.createElement(id);
                }
            },
            $$: function () {
            ...
            $A: function (o, b) {
                ...
                ;
                var l = o.length || 0, r = new Array(l);
                while (l--) {
                    r[l] = o[l];
                }
                ;
            ...
            case 'object':
                ...
                for (k in obj) {
                    if (obj.hasOwnProperty(k)) {
                        _t.push(k + '=' + ($.getType(obj[k]) == 'object' ? $.JSON.encode(obj[k]) : obj[k]));
                    }
                }
                ;
                return _t.join('&');
    ...
    $.namespace = function (S) {
        ...
        ;
        for (var i = 1, _iLen = A.length; i < _iLen; i++) {
            var T = A[i];
            if (!obj[T]) {
                obj[T] = {};
                obj = obj[T];
    ...
    $.extendView = function (t, a, b) {
        return $.view.call(t, a, b), t;
    }
    $.ext = function (e, o) {
        if (e === null || o === null) {
            return;
    ...
    $.layout = function (obj) {
        ...
        function _init(p, l) {
            var _l = l || {}, _n = _l.name, _t = _l.type.trim(), _a = _args[_n];
            _a.p = p;
            if (!_n || !_t || !_a) {
                console.log('组件初始化参数错误!');
                return false;
            }
            ;
            if (_t == 'Container') {
                _coms[_n] = p.adElm('div').cn(_a.cn || '').css(_a.css || '').h(_a.html || '');
                return false;
            }
            ;
            if (!$.UI[_t]) {
                console.log('在系统中未找到相关UI组件:' + _t);
                return false;
            }
            ;
                ...
                if (_vt == 'array') {
                    _v.ec(function (i) {
                        if (_com[k].h) {
                            ...
                            _init(_com.items[i].owner || _com.items[i].Body || _com.items[i].eBody, this[i]);
                        }
                        ;
                    });
                }
    ...
    $.ajax = function (a) {
        ...
        switch (_dt.toLowerCase()) {
            ...
            case 'json':
            case 'text':
                if (!window.ajaxObjPool) {
                    window.ajaxObjPool = new _ajax.XHRPool({max: 5});
                }
                ;
            ...
            case 'jsonp':
                window[_cb] = function (data) {
                    _args.onSuccess(data);
                };
                _load.loadjs(_url + '?callback=' + _cb + '&' + $.toArgsString(_args.data || _args.args)) + '&clienttime=' + _rand;
                break;
        }
        return $;
    };
    $.view = function (args, _args) {
        ...
        this.setArgs = function (a) {
            return this.args = a || {}, this.container = a.p || $DB, this.setOwner(this.container.fc()), this;
        };
        this.setOwner = function (o) {
            return this.owner = o, this;
        };
        this.set = function (key, value) {
            return this.args[key] = value, this;
        };
        this.get = function (key) {
            return this.args[key];
        };
        this.evt = function (key, fn) {
            return this.set(key, fn), this;
        };
        this.main = function () {
            return Array.prototype.slice.call(arguments).ec(function (i) {
                this[i]();
            }), this;
        };
        this.show = function () {
            return this.owner ? (this.owner.show(), (this.args.ifMask ? $.Layer.showMask() : void (0))) : void (0), this;
        };
        this.hide = function () {
            return this.owner ? (this.owner.hide(), (this.args.ifMask ? $.Layer.hideMask() : void (0))) : void (0), this;
        };
        this.remove = function () {
            this.owner ? this.owner.r() : void (0);
        };
    ...
    $.animate = function (a) {
        ...
        function exce() {
            n += _args.speed * 2;
            if (n >= _during) {
                _args.onRunning({value: _args.end});
                _args.onComplete({value: _args.end});
                clearTimeout(_start);
            } else {
                var _val = _tween[_args.easing](n, _args.begin, (_args.end - _args.begin), _during);
                _args.onRunning({value: _val});
                setTimeout(exce, _args.speed);
            }
            ;
        };
        return $;
    ...
    $.Q = function () {
        ...
        me.push = function (j) {//o对象 f函数指针 p函数参数 t延时方式 0 立即执行
            if ($.getType(j) == "array") {
                for (var i = 0; i < j.length; i++) {
                    var oj = j[i];
                    me.q.push({qType: oj.o, fn: oj.f, arg: oj.p, delay: oj.t});
                }
            }
            else me.q.push({qType: j.o, fn: j.f, arg: j.p, delay: j.t});
            return me;
        };
        me.wait = function (n) {
            me.q.push({
                qType: '_QB', fn: (function () {
                }), arg: null, delay: n
            });
            return me;
        };
        ...
        me.go = function () {
            ...
            ;
            if (rObj) {
                if (rObj == "_QB") rObj = rValue;
                rValue = qObj.fn.apply(rObj, qObj.arg)
            } else {
                rValue = qObj.fn.apply(null, qObj.arg);
            }
            if (dTime > 0) {
                setTimeout(function () {
                    me.q.shift();
    ...
    $.q = function (j) {
        ...
        var _onFinish = _j.onFinish || function () {
                console.log('end');
            };
        var ifStop = false;
        if (delay == null) {
    ...
    $.m = {
        ...
        toDecimal: function (x) {
            return isNaN(parseFloat(x)) ? false : Math.round(x * 100) / 100;
        }, //功能：保留两位小数 -- 将浮点数四舍五入，取小数点后2位
    ...
    $.e = {
        ...
        setInterval: function (f, t) {
            var args = [].slice.call(arguments, 2), fn = f;
            if (args.length > 0) {
                fn = function () {
                    f.apply(this, args)
                }
    ...
    $.g = {
        ...
        COL_S: '\u0002',
        RESULT_S: '\u0003',
        setImgPath: function (v) {
            return $.g.IMG_PATH = v, $.g;
        },
        getImgPath: function () {
            return $.g.IMG_PATH;
        }
    ...
    $.session = {
        key: 'M-SESSION-ID',
        set: function (v) {
            return $.ck.set($.session.key, v, 1), $.session;
        },
        get: function () {
            return $.ck.get($.session.key);
        },
        check: function () {
            return $.ck.get($.session.key) ? true : (MTips.show('登录超时, 请重新登陆!', 'warn'), setTimeout(function () {
                window.location.href = $.g.getImgPath() + 'index.html';
            }, 2000), false);
        }
    };
    $.drag = {
        ...
        drag: function (e) {
            ...
            if (o.maxX) ex = o.ih ? mi(ex, o.xMX) : mx(ex, o.iMX);
    ...
    $.ls = {
        set: function (k, v) {
            if (this.get(k) !== null) this.remove(k);
            $LS.setItem(k, v);
        },
        get: function (k) {
            var v = $LS.getItem(k);
        ...
        each: function (fn) {
            var n = $LS.length, i = 0, fn = fn || _fn, k;
            for (; i < n; i++) {
                k = $LS.key(i);
    ...
    $.noSel = function () {
        if ($D.selection) {
            if ($D.selection.empty)$D.selection.empty(); else {
                $D.selection = null;
            }
    ...
    $.skin = {
        ...
        setCssItem: function (s1, s2) {
            this.setStyle(this.getStyle(), s1, s2);
            return this;
        },
        setCss: function (o) {
            if ($.getType(o) == 'object') {
    ...
    $.aCache = {
        ...
        push: function (s, d, e) {
            this.hash[s] = {d: d, t: $.time(), e: e * 1000 || 10000};
            this.size += d.length;
            this.num++;
        },
        diff: function (s) {
    ...
    $.draw = function (req, option, cbFn) {
        ...
        var init = function () {
            ...
            mc.width = 0;
            if (!mc.getContext) {
                mc = $W.G_vmlCanvasManager.initElement(mc);
            }//直接调用是excanvas在IE下支持动态建立canvas
            me.mc2d = mc.getContext("2d");
            mc.setPos = function (x, y, w, h) {
                this.dc('pa');
                this.css($.box(x + ',' + y + ',' + w + ',' + h));
                this.width = 0;
                this.height = 0;
                this.width = w;
                this.height = h;
            ...
            mc.lineStyle = function (w, c, lj) {
                me.mc2d.strokeStyle = c || "#000";
                me.mc2d.lineWidth = w || 1;
                me.mc2d.lineJoin = lj || "round";
                return this;
            };
            mc.lTo = function (x, y) {
                me.mc2d.lineTo(x, y);
            ...
            mc.aTo = function (x, y, r, bs, es) {
                me.mc2d.arc(x, y, r, bs, es);
                return this;
            };
            mc.bTo = function (cx1, cy1, cx2, cy2, x, y) {
                me.mc2d.bezierCurveTo(cx1, cy1, cx2, cy2, x, y);
                mc.nowX = x;
                mc.nowY = y;
                return this;
            };
            mc.cTo = function (cx1, cy1, x, y) {
                me.mc2d.quadraticCurveTo(cx1, cy1, x, y);
                mc.nowX = x;
                mc.nowY = y;
                return this;
            };
            mc.fillStyle = function (col) {
                me.mc2d.fillStyle = col;
                return this;
            };
            mc.fill = function () {
                me.mc2d.fill();
            ...
            mc.fillText = function (txt, x, y, maxW) { /*if(+$("").split(',')[1]<9) return this;*/
                me.mc2d.fillText(txt, x, y, maxW);
                return this;
            };
            mc.textStyle = function (font, align) {
                me.mc2d.font = font || '12px sans-serif';
                return this;
            };
            mc.clearRect = function (x, y, w, h) {
                me.mc2d.clearRect(x, y, w, h);
                return this;
            };
            mc.clear = function () {
                me.mc2d.clearRect(0, 0, this.width, this.height);
                return this;
            };
            mc.save = function () {
                me.mc2d.save();
            ...
            mc.drawImage = function (img, x, y) {
                me.mc2d.drawImage(img, x, y);
                return this;
            };
            mc.getImageData = function (x, y, w, h) {
                return me.mc2d.getImageData(x, y, w, h);
            }
